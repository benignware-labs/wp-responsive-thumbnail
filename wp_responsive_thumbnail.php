...
function wp_responsive_thumbnail_html($html, $post_id, $post_thumbnail_id, $size, $attr) {
  ...
  $result = wp_responsive_attachment_image($post_thumbnail_id, $size, false, $attr);
  if ($result) {
    return $result;
  }
  return $html;
...
function wp_responsive_attachment_image($attachment_id, $size, $icon = false, $attr = array()) {
